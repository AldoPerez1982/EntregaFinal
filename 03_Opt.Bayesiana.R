...
# Optimizacion Bayesiana de hiperparametros de  lightgbm, con undersampling coverage
# 5-fold cross validation con vector de 5 semillas
...
kdirectorio_dataset<-"./exp/FE2303/dataset_7130.csv.gz"

kdirectortio_exp<-"./exp/" #Directorio donde queda el experimiento
kexperimento   <- "undersampling_0.25_LAG4" #Nombre del experimiento


ksemilla_azar  <- c(653507, 960889, 407717, 944717, 574201) #Vector semilla
#periodos en donde entreno
ktraining      <- c( 202011, 202012, 202101 )
...
set.seed( ksemilla_azar[1] );dataset[  , azar := runif( nrow( dataset ) ) ]
