...
kdataset       <- "./exp/FE2303/dataset_7130.csv.gz"
ksemilla_azar  <- 574201  #Aqui poner la propia semilla
ktraining      <- c( 202011,202012,202101 )   #periodos en donde entreno
kfuture        <- c( 202103 )   #periodo donde aplico el modelo final


kexperimento   <- "FINAL_1"

ksemilla_primos  <-  574201
ksemillerio  <- 50

kmax_bin           <-    31
klearning_rate     <-   0.0100800153629149
knum_iterations    <-   2690
knum_leaves        <-   84
kmin_data_in_leaf  <-  633
kfeature_fraction  <-   0.275744273367154
