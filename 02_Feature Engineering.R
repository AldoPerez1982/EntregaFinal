...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , mvr_mrentabilidadprom         := mrentabilidad  / mrentabilidad_annual ]
  dataset[ , mvr_mpasivosactivos         := (mactivos_margen  + mpasivos_margen)/2 ]
  dataset[ , mvr_mcuentascorr         := (mcuenta_corriente_adicional  + mcuenta_corriente)*ccuenta_corriente ]
  dataset[ , mvr_mcajaahorro         := (mcaja_ahorro  + mcaja_ahorro_adicional + mcaja_ahorro_dolares) * ccaja_ahorro ]
...
dir.create( "./exp/FE2303/", showWarnings = FALSE )
setwd("./exp/FE2303/")   #Establezco el Working Directory DEL EXPERIMENTO
